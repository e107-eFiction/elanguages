...
define ("_FEATUREDNOTE", "<b>Note:</b> To retire a featured story click on the <strong>"._RETIRE."</strong> link.  To make a retired featured story current again, click on the <strong>".LAN_CURRENT."</strong> link.  Clicking on <strong>"._REMOVE."</strong> removes the featured status entirely."); 
